...
class AuditServiceSpec extends UnitSpec with MockitoSugar with Eventually {
  ...
  "auditService" should {
    ...
    "send an ApiPlatformEventsWithMongodbSomethingHappened event with the correct fields" in {
      ...
      await(
        service.sendApiPlatformEventsWithMongodbSomethingHappened(
          model,
          Arn("ARN0001"))(hc,
      ...
      eventually {
        ...
        sentEvent.auditType shouldBe "ApiPlatformEventsWithMongodbSomethingHappened"
        sentEvent.auditSource shouldBe "api-platform-events-with-mongodb"
        ...
        sentEvent.tags("transactionName") shouldBe "api-platform-events-with-mongodb-something-happened"
