...
import uk.gov.hmrc.apiplatformevents.models.ReactiveMongoFormattersV2
...
@Singleton
class ApplicationEventsV2Repository @Inject()(
    mongoComponent: ReactiveMongoComponent)
    extends ReactiveRepository[ApplicationEvent, BSONObjectID](
      "application-events",
      mongoComponent.mongoConnector.db,
      ReactiveMongoFormattersV2.formatApplicationEvent,
